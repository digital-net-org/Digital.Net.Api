...
/// <summary>
///     Total, cross-schema order over mutations: <c>(CreatedAt, Id)</c>. Serialized as the SSE
...
public readonly record struct MutationCursor(DateTime CreatedAt, Guid Id)
{
    ...
    /// <summary>Opaque, parseable encoding: <c>{ticks}:{guid:N}</c> (ticks of the UTC timestamp).</summary>
