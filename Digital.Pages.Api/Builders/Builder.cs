...
using Digital.Pages.Services;
using Swashbuckle.AspNetCore.Annotations;

namespace Digital.Pages.Api.Builders;
...
public static class Builder
{
    ...
    private static WebApplicationBuilder AddSwagger(this WebApplicationBuilder builder)
    {
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "Digital.Pages", Version = "v1.0" });
            c.EnableAnnotations();
            c.OrderActionsBy(
