...
//
// public class GetUserApiTest : IntegrationTest<Program, DigitalContext>
// {
//     private readonly UserFactory _userFactory;
//     private readonly List<User> _userPool;
//
//     public GetUserApiTest(AppFactory<Program, DigitalContext> fixture) : base(fixture)
//     {
...
//             Role = UserRole.Admin
//         });
//         AuthenticationCollection.Login(BaseClient, (string)user.Login, (string)password).Wait();
//
//         List<User> users = [];
//         for (var i = 0; i < 25; i++)
//         {
