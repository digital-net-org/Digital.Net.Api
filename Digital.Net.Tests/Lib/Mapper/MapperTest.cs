...
namespace Digital.Net.Tests.Lib.Mapper;
...
public class MapperTests : UnitTest
{
    ...
    public async Task Map_ReturnsInstanceOfTargetType_WhenMatchingPropertiesFound()
    {
        ...
        var result = Net.Lib.Models.Mapper.Map<Source, Target>(source);
    ...
    {
        var source = new Source { Value = 42 };
        var result = Net.Lib.Models.Mapper.Map<Source, TargetFail>(source);
        await Assert.That(result).IsNotNull();
    ...
    public async Task MapFromConstructor_ReturnsInstanceOfTargetType_WhenSuitableConstructorFound()
    {
        ...
        var result = Net.Lib.Models.Mapper.MapFromConstructor<FromConstructorSource, FromConstructorTarget>(source);
        await Assert.That(result).IsNotNull();
    ...
    public async Task MapFromConstructor_ThrowsInvalidOperationException_WhenNoSuitableConstructorFound()
    {
        var source = new FromConstructorSource { Value = 42 };
        await Assert.That(() =>
                Net.Lib.Models.Mapper.MapFromConstructor<FromConstructorSource, TestNoSuitableConstructorClass>(source))
    ...
    public async Task TryMap_UsesConstructorMapping_WhenAvailable()
    {
        ...
        var result = Net.Lib.Models.Mapper.TryMap<Source, TargetWithConstructor>(source);
        await Assert.That(result).IsNotNull();
    ...
    public async Task TryMap_UsesPropertyMapping_WhenConstructorMappingFails()
    {
        ...
        var result = Net.Lib.Models.Mapper.TryMap<Source, TargetWithProperties>(source);
        await Assert.That(result).IsNotNull();
    ...
    public async Task TryMap_UsesConstructorMapping_ForList_WhenAvailable()
    {
        ...
        var result = Net.Lib.Models.Mapper.TryMap<Source, TargetWithConstructor>(source).ToList();
        await Assert.That(result).IsNotNull();
    ...
    public async Task TryMap_UsesPropertyMapping_ForList_WhenConstructorMappingFails()
    {
        ...
        var result = Net.Lib.Models.Mapper.TryMap<Source, TargetWithProperties>(source).ToList();
        await Assert.That(result).IsNotNull();
        await Assert.That(result.Count).IsEqualTo(2);
